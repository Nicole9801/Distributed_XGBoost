...
## Load model and inspect global model config  
global_model = xgb.Booster()

global_model.load_model("global_xgb_model.json") 
global_model_params = global_model.save_config()
...
objective = params_dict["learner_train_param"]["objective"]
num_features = params_dict["learner_model_param"]["num_feature"]

# Print model summary
print(f"Global XGBoost Model Summary:")
